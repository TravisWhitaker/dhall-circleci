...
let renderExecMapKey =
      ...
      → let fs =
              { Docker =
                  λ(_ : List RenderDockerConfig) → "docker"
              , Machine =
                  λ(_ : RenderMachineConfig) → "machine"
              , MacOS =
                  λ(_ : RenderMacOSConfig) → "macos"
              }
...
let RenderExecutor =
      { mapKey :
          Text
      , mapValue :
          List { mapKey : Text, mapValue : RenderExecutorMapVal }
      }
            ...
            in  { mapKey =
                ...
                , mapValue =
                    [ { mapKey =
                          recKey
                      , mapValue =
                          RenderExecutorMapVal.ExecConfig rec
                      }
                    , { mapKey =
                          "resource_class"
                      , mapValue =
                          RenderExecutorMapVal.ResClass e.execResourceClass
                      }
                    , { mapKey =
                          "shell"
                      , mapValue =
                          RenderExecutorMapVal.Shell e.execShell
                      }
                    , { mapKey =
                          "working_directory"
                      , mapValue =
                          RenderExecutorMapVal.WorkingDir e.execWD
                      }
                    , { mapKey =
                          "environment"
                      , mapValue =
...
let renderJobExecConfig =
      ...
      → let fs =
              ...
              , NamedExec =
                  λ(n : Text) → RenderJobExecConfig.NamedExec n
              }
...
let renderJobExecMapKey =
      ...
      → let fs =
              { ExecConfig =
                  λ(c : RenderExecConfig) → renderExecMapKey c
              , NamedExec =
                  λ(_ : Text) → "executor"
              }
...
let RenderJob =
      { mapKey :
          Text
      , mapValue :
          List { mapKey : Text, mapValue : RenderJobMapVal }
      }
            ...
            in  { mapKey =
                ...
                , mapValue =
                    [ { mapKey =
                          rjcKey
                      , mapValue =
                          RenderJobMapVal.ExecConfig rjc
                      }
                    , { mapKey =
                          "shell"
                      , mapValue =
                          RenderJobMapVal.Shell j.jobShell
                      }
                    , { mapKey =
                          "steps"
                      , mapValue =
                    ...
                    , { mapKey =
                          "working_directory"
                      , mapValue =
                          RenderJobMapVal.WorkingDir j.jobWD
                      }
                    , { mapKey =
                          "parallelism"
                      , mapValue =
                          RenderJobMapVal.Parallel j.jobParallelism
                      }
                    , { mapKey =
                          "environment"
                      , mapValue =
                    ...
                    , { mapKey =
                          "resource_class"
                      , mapValue =
                          RenderJobMapVal.ResClass j.jobResourceClass
                      }
                    ]
                }
